...
title = "Proportional for run"

df = pd.read_csv(infile)

fig = px.scatter(df, x='Time', y='Proportional',  title=title, width=1000, height=600,trendline="lowess", trendline_options=dict(frac=0.1),trendline_color_override="red")
